    ...
    <div className="w-5/6 mx-auto p-7">
      ...
      >
        ...
        <div className="form-control w-full max-w-xs">
          <label className="label">
            {" "}
            <span className="label-text">Re-sell Price</span>
          </label>
          <input
            type="text"
        ...
        <div className="form-control w-full max-w-xs">
          <label className="label">
            {" "}
            <span className="label-text">How many year you use it?</span>
          </label>
          <input
            type="text"
        ...
        <div className="form-control w-full max-w-xs">
          ...
          />
          {errors.img && <p className="text-green-500">{errors.img.message}</p>}
        </div>

        <div className="col-span-2 text-center mt-8">
          <input
            className="btn btn-accent mt-4  w-96 "
            value="Add Item"
            type="submit"
          />
        </div>
